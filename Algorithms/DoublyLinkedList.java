...
class DoublyLinkedList<T extends Comparable<T>> {
	 ...
	 *
	 *         Justification: There are no loops, only one if statement
	 */
	 ...
	 *
	 *         Justification: The worst case scenario is that the while loop runs to the end of the list of nodes making the 
	 ...
	 *         Worst-case asymptotic running time cost: Theta(n)
	 *
	 *         Justification: Assuming the worst case scenario the while loop will run to the end of the list which makes the
	 *         worst case run time theta(n)
	 *
	 */
	 ...
	 *         Worst-case asymptotic running time cost: Theta(n)
	 *
	 *         Justification: There is a single while loop, if it runs the worst case scenario, which we assume the run time will
	 *         be theta(n)
	 */
	 ...
	 * Worst-case asymptotic running time cost: Theta(n)
	 *
	 * Justification: There is a single while loop.
	 */
	public void reverse() {
		DLLNode currentNode = head;
		DLLNode temp = null;
	 ...
	 *
	 * Justification: there is a nested while loop so as we asssume worst case run time the second while loop will run
	 * 					n times for each iteration of the first which would be n, making the overall run time n^2.
	 */
	 ...
	 *             Worst-case asymptotic running time cost: Theta(1)
	 *
	 *             Justification: there are no loops just an if else statement
	 */
	 ...
	 *         Worst-case asymptotic running time cost: Theta(1)
	 *
	 *         Justification: there are no loops.
	 */
	public T pop() {
		if (isEmpty()) {
			return null;
