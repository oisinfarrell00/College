/**
* Author: Tobias Budig and Oisin Farrell
*
*/
model lab4
...
global {
    ...
    int population_infected <- nb_infected_init update: (people + list_people_in_buildings) count (each.is_infected);
    int population_not_infected <- population - nb_infected_init update: population - population_infected;
    bool is_night <- true update: current_date.hour < 7 or current_date.hour > 20;
    float infected_rate update: population_infected / population;
...
experiment main_experiment type: gui {
    ...
    display chart refresh: every(10 #cycles) {
        ...
        data "susceptible" value: population_not_infected color: #green marker: false;
        data "infected" value: population_infected color: #red marker: false;
        }
    }
    }
}